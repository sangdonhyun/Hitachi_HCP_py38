...
class conn_test():
    ...
    def main(self):
        self.target_url
        self.port_scan(self.target_url,80)
        self.port_scan(self.target_url,8000)
        self.port_scan(self.target_url,443)
        self.port_scan(self.target_url,9090)
        adm_url = 'admin.{}'.format(self.target_url)
        self.port_scan(adm_url, 80)
        self.port_scan(adm_url, 8000)
        self.port_scan(adm_url, 443)
        self.port_scan(adm_url, 9090)
